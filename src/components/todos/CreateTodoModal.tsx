              ...
              <div className="flex items-center justify-between mb-1.5">
                ...
                <div className="flex gap-1 text-[11px]">
                  <button
                    ...
                    className="px-2 py-0.5 rounded bg-slate-200/80 dark:bg-slate-800 hover:bg-indigo-100 hover:text-indigo-600 dark:hover:bg-indigo-900/50 transition-colors"
                  >
                    Today
                  </button>
                  <button
